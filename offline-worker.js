...
const allowed=url=>url.origin===self.location.origin&&([".nojekyll","apple-touch-icon.png","assets","credits.html","emulator","favicon.svg","fonts","frame-source.js","game-thumbnails","games","graphics-preview","index.html","manifest.webmanifest","offline-assets.json","offline-worker.js","pack-draw.js","pack-effects.js","pack-engine.js","pack-map.js","pack-match.js","pack-scenery.js","pack-ui.js","pack-worker.js","packs","player-runtime.js","player.html","power-core","power-player.js","preview","touch-controls.js"].includes(url.pathname.split('/')[1])||url.pathname==='/')&&!url.pathname.startsWith('/api/')&&!url.pathname.includes('/auth/');
